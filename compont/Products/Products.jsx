...
const Products = () => {
  ...
  const {data,loading,error} = useFetch(`/sub-categories?[filters][categories][id][$eq]=${cat_id}`)
    ...
    <div className='products'>
      ...
      <div className="right">
        <img className='catImg' src="https://images.pexels.com/photos/1074535/pexels-photo-1074535.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
          <List cat_id={cat_id} maxPrice={maxPrice} sort={sort} SubCats={selectedSubCats}/>
      </div>
    </div>
  )
}
